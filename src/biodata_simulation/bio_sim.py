...
class Simulation:
	def __init__(self, output="output.csv", max_steps=5000):
		self.fitness = [1.012, 1.142, 1.105, 1.027, 1.000, 1.103, 1.118, 1.047, 1.022, 1.205, 1.149, 1.93,
	...
	def generate_child(self):	
		return random.randint(0,len(Genotype)-1)
	...
	def update(self):
		...
		for j in range(len(self.weights)):
			self.weights[j] = self.weights[j] / s
